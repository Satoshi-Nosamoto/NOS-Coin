...
In order to support loading of multiple wallets in nos-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is nos.cpp.
...
Changes to nos.cpp
----------------------
nos.cpp is the entry point into nos-qt, and as such, will require some minor modifications to provide hooks for
