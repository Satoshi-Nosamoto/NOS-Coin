...
RESOURCES += src/qt/nos.qrc src/qt/nos_locale.qrc

TRANSLATIONS += src/qt/locale/nos_bg.ts \
                src/qt/locale/nos_de.ts \
                src/qt/locale/nos_en.ts \
                src/qt/locale/nos_es.ts \
                src/qt/locale/nos_fi.ts \
                src/qt/locale/nos_fr.ts \
                src/qt/locale/nos_it.ts \
                src/qt/locale/nos_ja.ts \
                src/qt/locale/nos_pl.ts \
                src/qt/locale/nos_pt.ts \
                src/qt/locale/nos_ru.ts \
                src/qt/locale/nos_sk.ts \
                src/qt/locale/nos_sv.ts \
                src/qt/locale/nos_vi.ts \
                src/qt/locale/nos_zh_CN.ts \
                src/qt/locale/nos_zh_TW.ts
