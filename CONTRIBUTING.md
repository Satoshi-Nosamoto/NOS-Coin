Contributing to Nos Core
============================

The Nos Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Nos Core project, and is not to be
confused with overall Nos Network Protocol consensus changes.

Whether a pull request is merged into Nos Core rests with the project merge
...
Patches that change Nos consensus rules are considerably more involved than
...
Where a patch set proposes to change the Nos consensus, it must have been
...
The project leader is the release manager for each Nos Core release.
