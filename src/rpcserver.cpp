...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Nos features */
        {"nos", "masternode", &masternode, true, true, false},
        {"nos", "listmasternodes", &listmasternodes, true, true, false},
        {"nos", "getmasternodecount", &getmasternodecount, true, true, false},
        {"nos", "masternodeconnect", &masternodeconnect, true, true, false},
        {"nos", "masternodecurrent", &masternodecurrent, true, true, false},
        {"nos", "masternodedebug", &masternodedebug, true, true, false},
        {"nos", "startmasternode", &startmasternode, true, true, false},
        {"nos", "createmasternodekey", &createmasternodekey, true, true, false},
        {"nos", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"nos", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"nos", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"nos", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"nos", "getmasternodescores", &getmasternodescores, true, true, false},
        {"nos", "mnbudget", &mnbudget, true, true, false},
        {"nos", "preparebudget", &preparebudget, true, true, false},
        {"nos", "submitbudget", &submitbudget, true, true, false},
        {"nos", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"nos", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"nos", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"nos", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"nos", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"nos", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"nos", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"nos", "checkbudgets", &checkbudgets, true, true, false},
        {"nos", "mnsync", &mnsync, true, true, false},
        {"nos", "spork", &spork, true, true, false},
        {"nos", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"nos", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use nosd, or the -server option to nos-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> nos-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:7171/\n";
}
