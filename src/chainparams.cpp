...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x00000f44b41030d51c381ad64f4a537e7ce2e68c99011c5bdaea75fffc867f9b"));
...
public:
    CMainParams()
    {
        ...
        genesis.nNonce = 1951205;
				
		
				
		hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000f44b41030d51c381ad64f4a537e7ce2e68c99011c5bdaea75fffc867f9b"));
        assert(genesis.hashMerkleRoot == uint256("0x393ad1982b271132f0351e286db3ac44e47d77bf36ae22871e664e20ab6950e7"));

 
		vSeeds.push_back(CDNSSeedData("nos.mnseeds.com", "nos.mnseeds.com"));// Seeder
		vSeeds.push_back(CDNSSeedData("nos.seeds.mn.zone", "nos.seeds.mn.zone"));// Seeder
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Nos: 1 day
        nTargetSpacing = 1 * 60;  // Nos: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet nos addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet nos script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet nos BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet nos BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet nos BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Nos: 1 day
        nTargetSpacing = 1 * 60;        // Nos: 1 minutes
