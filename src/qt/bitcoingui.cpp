                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Nos Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Nos address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and nos: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zNOS"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Nos Core"), this);
    aboutAction->setStatusTip(tr("Show information about Nos Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Nos"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Nos addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Nos addresses"));
    ...
    openAction->setStatusTip(tr("Open a Nos: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Nos Core help message to get a list with possible Nos command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Nos Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Nos network", "", count));
}
...
{
    QString strTitle = tr("Nos Core"); // default title
...
/** Creates context menu, its actions, and noss up all the relevant signals for mouse events. */
