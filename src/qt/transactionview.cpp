                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Nos from zNos"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zNos"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zNos));
